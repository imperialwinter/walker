	...
	imp_com_mil1 = {
		{
			...
			buttonname = 'Upg: Def',
			name = 'Upgrade: Defense',
			desc = 'Further fortifies Base with Turbolasers, heavy anti-air, sheilds, and buildable Royal Guards',
			notext = true,
			buildpic = 'upgrades/imp_com_mil.png',
			onUpgrade = function(oldUnitID, newUnitID, _)
				HQGuardTransfer(oldUnitID, newUnitID)
	...
	imp_com_res1 = {
		{
			...
			buttonname = 'Upg: Comm',
			name = 'Upgrade: Command',
			desc = 'Adds Dark Trooper build option and improved resource generation and sensors',
			notext = true,
			buildpic = 'upgrades/imp_com_econ.png',
			onUpgrade = function(oldUnitID, newUnitID, _)
				HQGuardTransfer(oldUnitID, newUnitID)
